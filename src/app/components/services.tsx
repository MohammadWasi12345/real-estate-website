...
const Services = () => {
    return (
        <div className='bg-blue-500 ' id='Services'>
            <div className='text-white mb-5 text-center font-extrabold font-2 capitalize text-3xl md:5xl'><h1 className='pt-9'>our services</h1></div>
